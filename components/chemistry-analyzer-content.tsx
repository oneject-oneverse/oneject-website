...
const product = {
  ...
  specifications: [
    ...
    "Test Positions: 60 sample positions",
    "Reagent Positions: 40 refrigerated positions",
    "Sample Volume: 2-45 μL",
    "Display: 15.6\" Touch Screen LCD",
    "Memory: 100,000 patient results"
  ],
  description: "The Oneject Chemistry Analyzer is a fully automated clinical chemistry system designed for high-throughput testing in clinical laboratories. With advanced photometric technology and intelligent software, it delivers precise and reliable results for routine and specialized chemistry testing.",
  features: [
...
export function ChemistryAnalyzerContent() {
  return (
        ...
        <div className="container mx-auto max-w-screen-xl px-4">
          <div className="relative z-10 max-w-3xl">
            ...
            <p className="mt-6 max-w-[600px] text-gray-300 md:text-xl">
              Advanced automated clinical chemistry system for comprehensive diagnostic testing.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-screen-xl px-4">
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              {/* Test Menu */}
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-[#3F8F81]">Test Menu</h3>
                <ul className="grid grid-cols-2 gap-2">
                  {product.testMenu.map((test, idx) => (
                    <li key={idx} className="flex items-center text-gray-600">
                      <span className="mr-2 h-1.5 w-1.5 rounded-full bg-[#6DC5EE]" />
                      {test}
                    </li>
