      ...
      <div className="container mx-auto max-w-screen-xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-[#5B5856]">
              <div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/news" className="text-[#5B5856] hover:text-primary">News</Link>
              </li>
              <li>
                <Link href="/career" className="text-[#5B5856] hover:text-primary">Career</Link>
              </li>
              <li>
                <Link href="/contact" className="text-[#5B5856] hover:text-primary">Contact Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link href="https://facebook.com" className="text-[#5B5856] hover:text-primary">
                <Facebook className="h-6 w-6" />
                <span className="sr-only">Facebook</span>
              </Link>
              <Link href="https://instagram.com" className="text-[#5B5856] hover:text-primary">
                <Instagram className="h-6 w-6" />
                <span className="sr-only">Instagram</span>
              </Link>
              <Link href="https://linkedin.com" className="text-[#5B5856] hover:text-primary">
